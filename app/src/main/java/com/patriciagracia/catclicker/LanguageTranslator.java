        ...
        if (currentLanguage == Language.SPANISH) {
            return new String[]{
                    ...
                    "¿Pero que...-? ¿Felicidades? ¿Cómo es que has sacado tiempo y ganas para esto? " +
                            "Lo único que puedo ofrece es el enlace a github con todo el código del proyecto , te animo a que hagas tu versión o lo que quieras con el, es público." +
            ...
            return new String[]{
                    ...
                    "But what...-? congratulations? how did you find the time and will for this? " + "Let's do something. " +
                            "The only thing I can offer is the link to github with all the code of the project, I encourage you to make your version or whatever you want with it, it is public. " +
